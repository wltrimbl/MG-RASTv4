function initWebApp () {
	...
	Retina.load_widget({"name": "login", "resource": "Retina/widgets"}).then( function() {
	    ...
	    Retina.Widget.create('login', { "target": document.getElementById("login_space"),
					    ...
					    "helpEnabled": true,
					    "helpMenu": [
						{ "title": "<img src='Retina/images/pencil.png' style='width: 16px; position: relative; bottom: 1px; margin-right: 5px;'> blog", "url": "https://blog.mg-rast.org" },
						{ "title": "<img src='Retina/images/file-pdf.png' style='width: 16px; position: relative; bottom: 1px; margin-right: 5px;'> manual", "url": "https://help.mg-rast.org/user_manual.html" },
